...
return new class extends Migration
{
    ...
    {
        $roles = ['master_admin', 'head_admin', 'admin', 'hr', 'foreman', 'client', 'designer'];
    ...
    {
        $targetRoles = ['head_admin', 'admin', 'hr', 'foreman', 'client', 'designer'];
        DB::table('users')->where('role', 'master_admin')->update(['role' => 'head_admin']);
