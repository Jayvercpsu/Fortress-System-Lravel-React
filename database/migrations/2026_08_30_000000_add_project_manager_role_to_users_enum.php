...
return new class extends Migration
{
    ...
    {
        $roles = ['master_admin', 'head_admin', 'admin', 'hr', 'foreman', 'client', 'designer', 'project_manager'];
    ...
    {
        $targetRoles = ['master_admin', 'head_admin', 'admin', 'hr', 'foreman', 'client', 'designer'];
        DB::table('users')->where('role', 'project_manager')->update(['role' => 'head_admin']);
