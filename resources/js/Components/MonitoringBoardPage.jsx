                                ...
                                return (
                                    <tr key={scope.id}>
                                        ...
                                        <td style={{ padding: '10px 8px', borderBottom: '1px solid var(--border-color)' }}>
                                            {isEditing ? (
                                                <div style={{ display: 'inline-flex', gap: 8 }}>
                                                    <ActionButton type="button" onClick={() => setEditingScopeId(null)} style={{ padding: '8px 10px' }}>Cancel</ActionButton>
                                                    <ActionButton type="button" variant="success" disabled={updating} onClick={(event) => saveEdit(event, scope.id)} style={{ padding: '8px 10px' }}>Save</ActionButton>
                                                </div>
                                            ) : (
                                                <div style={{ display: 'inline-flex', gap: 8 }}>
