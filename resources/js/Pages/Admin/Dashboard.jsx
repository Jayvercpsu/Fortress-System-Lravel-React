                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                ...
                                <tbody>
                                    {recentMaterials.map((m, i) => (
                                        <tr key={i} style={{ borderBottom: '1px solid var(--row-divider)' }}>
                                            <td style={{ padding: '10px 16px', fontSize: 13, fontWeight: 600 }}>{m.foreman}</td>
                                            <td style={{ padding: '10px 16px', fontSize: 13, color: 'var(--text-muted)' }}>{m.material}</td>
                                ...
                                <tbody>
                                    {recentIssues.map((r, i) => (
                                        <tr key={i} style={{ borderBottom: '1px solid var(--row-divider)' }}>
                                            ...
                                            <td style={{ padding: '10px 16px', fontSize: 13, color: 'var(--text-muted)' }}>{r.title}</td>
                                ...
                                <tbody>
                                    {recentAttendance.map((a, i) => (
                                        <tr key={i} style={{ borderBottom: '1px solid var(--row-divider)' }}>
                                            ...
                                            <td style={{ padding: '10px 16px', fontSize: 13, color: 'var(--text-muted)' }}>{a.role}</td>
                                            <td style={{ padding: '10px 16px', fontSize: 12, color: 'var(--text-muted-2)', ...mono }}>{a.date}</td>
                            ...
                            <tbody>
                                {recentDeliveries.map((d, i) => (
                                    <tr key={i} style={{ borderBottom: '1px solid var(--row-divider)' }}>
                                        ...
                                        <td style={{ padding: '10px 16px', fontSize: 13, ...mono, color: 'var(--text-muted)' }}>{d.qty}</td>
                                        <td style={{ padding: '10px 16px', fontSize: 12, ...mono, color: 'var(--text-muted-2)' }}>{d.date}</td>
