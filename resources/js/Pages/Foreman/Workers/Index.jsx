...
export default function ForemanWorkersIndex({ workers = [], workerTable = {}, assignedProjects = [] }) {
    ...
    const canManageWorkers = ['hr', 'head_admin'].includes(auth?.user?.role);
                ...
                <div style={{ display: 'grid', gap: 16 }}>
                    {canManageWorkers ? (
                        ...
                        <div style={{ ...cardStyle, display: 'grid', gap: 8 }}>
                            <div style={{ fontWeight: 700 }}>Workers (Read-only)</div>
                            <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                                HR adds and assigns workers to your site. This list is view-only for foremen.
                            </div>
                        </div>
                    )}
                    ...
                    <div style={cardStyle}>
                        <DataTable
                            ...
                            emptyMessage="No workers yet. Ask HR to add workers for your site."
                            serverSide
