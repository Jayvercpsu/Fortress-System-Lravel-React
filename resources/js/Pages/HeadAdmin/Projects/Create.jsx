...
export default function HeadAdminProjectsCreate({ foremen = [], designers = [], clientOptions = [] }) {
    ...
    const submit = (e) => {
        ...
        post('/projects', {
            ...
            onSuccess: () => toast.success(toastMessages.projects.createSuccess),
        });
    };
    ...
    return (
        <>
            ...
            <Layout title="Create Project">
                ...
                <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-3.5" style={{ background: 'var(--surface-1)', border: '1px solid var(--border-color)', borderRadius: 12, padding: 16 }}>
                    <label>
