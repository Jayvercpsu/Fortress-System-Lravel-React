...
export const routeCoverage: Record<RoleKey, RouteExpectation[]> = {
    ...
    head_admin: [
        ...
        { name: 'Project overview', path: `/projects/${DEMO_PROJECT_ID}?tab=overview`, bodyText: 'Project - Fortress Building' },
    ...
    hr: [
        ...
        { name: 'Worker rates page', path: '/payroll/worker-rates', bodyText: 'Worker Rate Management' },
    ...
    foreman: [
        ...
        { name: 'Foreman workers page', path: '/foreman/workers', bodyText: 'Workers (Read-only)' },
...
export const forbiddenCoverage: Record<RoleKey, string[]> = {
    ...
    admin: [
        '/users',
        '/projects/create',
        // Projects board/show are head-admin only as of the project ownership change.
        '/projects',
